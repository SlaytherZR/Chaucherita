	...
	<div class="container-fluid ">
		<div class="row">
			...
			<div class="col-10">
				...
				<div class="row">
					<div class="col-10 d-flex justify-content-around">
						...
						<img src="${pageContext.request.contextPath}/imgs/Logo.jpg"
							alt="logoChau" class="logos">
						<div>
							<span>Usuario: <c:out value="${userLoggedIn.name}" /></span> <img
								src="${pageContext.request.contextPath}/imgs/Usuario.png"
								alt="logoUser" class="logos">
						</div>
					</div>
				...
				<div class="row">
					<form class="col-10"
						action="AccountManagerController?rute=saveMovement" method="POST">
						<div class="row">
							<div class="col"></div>
									...
									<div class="">
										<div class="form-check">
											<input class="form-check-input" type="radio" name="category"
												id="radioGasto" value="Gasto" checked> <label
												class="form-check-label" for="radioGasto">Gasto</label>
										</div>
										<div class="form-check">
											<input class="form-check-input" type="radio" name="category"
												id="radioIngreso" value="Ingreso"> <label
												class="form-check-label" for="radioIngreso">Ingreso</label>
										</div>
										<div class="form-check">
											<input class="form-check-input" type="radio" name="category"
												id="radioTransferencia" value="Transferencia"
									...
									<div class="contLog">
										<div class="d-flex inputConf2">
											<span class="m-3">Cantidad: </span> <input type="text"
												class="inputConf p-2 ms-2 colorMI" id="cantidad"
												name="amount" placeholder="Digite la cantidad...">
										</div>

										<div class="d-flex inputConf2">
											<div class="row align-items-center">
												<span class="col m-2">Cuenta de Destino: </span> <select
													class="col-12" id="selectTransf" disabled>
												...
												<input type="submit"
													class="no-underline colorBtn confBtn confBtn2"
